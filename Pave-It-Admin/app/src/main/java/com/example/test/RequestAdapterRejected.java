...
public class RequestAdapterRejected extends RecyclerView.Adapter<RequestAdapterRejected.RequestViewHolder> {

    private List<RequestItem> requestList;
    private Context context;

    public RequestAdapterRejected(List<RequestItem> requestList, Context context) {
